      ...
      <Container className="py-3">
        <div className="flex items-center justify-between gap-3 lg:hidden">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-950 text-xs font-semibold uppercase tracking-[0.32em] text-white">
              AM
            </div>
            <div>
              <p className="font-display text-xl tracking-tight text-stone-950">Auralux</p>
