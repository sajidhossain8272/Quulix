    ...
    <section aria-labelledby="latest-articles-heading" className="py-14 sm:py-18 lg:py-22">
      <Container>
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left pb-8 sm:pb-12 border-b border-stone-200">
          <div>
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-stone-500 mb-2">
          ...
          <Link
            href="/category/all"
            className="inline-flex items-center justify-center rounded-full border border-stone-300 bg-white px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.08em] text-stone-800 shadow-sm transition hover:border-stone-400 hover:bg-stone-50"
          >
            Explore All Guides
        ...
        {/* Article Cards Grid (Matching Reference Screenshot 3) */}
          ...
          {articles.map((article) => (
            ...
            >
              ...
              <div className="relative aspect-[16/11] w-full overflow-hidden bg-stone-100">
                ...
                {/* Reference-matching Date Badge (Top Left) */}
                <div className="absolute top-3 left-3 flex flex-col items-center justify-center rounded-xl bg-white/95 px-2.5 py-1.5 shadow-md backdrop-blur-md">
                ...
                <div className="absolute bottom-3 right-3">
                  <span className="rounded-full bg-stone-950/75 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-white backdrop-blur-md">
                    {article.category}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col justify-between p-5">
                <div className="space-y-2.5">
                  ...
                  <h3 className="font-display text-base font-bold text-stone-900 line-clamp-2 transition-colors group-hover:text-amber-700">
                    {article.title}
                  </h3>
                ...
                {/* Bottom Read Action */}
                <div className="pt-4 mt-4 border-t border-stone-100 flex items-center justify-between text-xs font-bold uppercase tracking-[0.06em] text-stone-900">
                  <span className="group-hover:text-amber-700 transition-colors">Read Article</span>
                  <ArrowUpRight className="h-4 w-4 transform transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-amber-700" />
                </div>
              </div>
            </article>
          ))}
