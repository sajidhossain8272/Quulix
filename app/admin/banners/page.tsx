    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">Manage the storefront banners, optional copy, CTA, order, and visibility.</p>
        </div>
        <Link href="/admin/banners/new" className="flex shrink-0 items-center gap-2 rounded-lg bg-black px-4 py-2 font-medium text-white transition-colors hover:bg-gray-900">
